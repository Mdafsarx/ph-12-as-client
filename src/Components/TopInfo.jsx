    ...
    return (
        <div className="max-w-7xl mx-auto p-2 pb-3 flex flex-col md:flex-row items-center justify-between px-5 border-b-2 border-[#E49BFF]">
            ...
            <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13" data-aos="fade-left" data-aos-duration="2000"  data-aos-delay="700">
                ...
                <a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#7EA1FF] text-white">
                ...
                <a rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center justify-center w-10 h-10 rounded-full bg-[#7EA1FF] text-white ">
