    ...
    return (
        <div className="pb-24">
            ...
            <div className="pt-24">
                ...
                <div className="grid md:grid-cols-2 gap-10 max-w-7xl mx-auto px-5 pt-14">
            ...
            <div className="grid md:grid-cols-2 gap-10 max-w-7xl mx-auto px-5 pt-24">
                ...
                <div className="space-y-3 flex flex-col justify-center" data-aos="fade-left" data-aos-duration="1500">
                   ...
                   <a target="_blank" href="https://www.google.com/maps/place/Sylhet/@24.8999805,91.8198358,13z/data=!3m1!4b1!4m6!3m5!1s0x375054d3d270329f:0xf58ef93431f67382!8m2!3d24.9047808!4d91.8600079!16zL20vMDJ0ZDJ4?entry=ttu">
                     <button
                         className="text-xl w-32 h-12 rounded bg-[#789cff] text-black relative overflow-hidden group z-10 hover:text-black duration-1000">
                         <span
                             className="absolute bg-[#789cff] w-36 h-36 rounded-full group-hover:scale-100 scale-0 -z-10 -left-2 -top-10 group-hover:duration-500 duration-700 origin-center transform transition-all"
                         ></span>
                         <span
                             className="absolute bg-[#E49BFF] w-36 h-36 -left-2 -top-10 rounded-full group-hover:scale-100 scale-0 -z-10 group-hover:duration-700 duration-500 origin-center transform transition-all"
                         ></span>
