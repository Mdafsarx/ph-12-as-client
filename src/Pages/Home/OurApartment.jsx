    ...
    return (
        <div className="grid md:grid-cols-2 gap-10 max-w-7xl mx-auto py-20 px-5">
            ...
            <div className="grid grid-cols-2 gap-4">
                <img src={img1} className="h-52 rounded-xl"/>
                <img src={img2} className="h-52 rounded-xl"/>
                <img src={img3} className="h-52 rounded-xl"/>
                <img src={img4} className="h-52 rounded-xl"/>
            </div>
