    ...
    return (
        <div className="grid md:grid-cols-2 gap-10 max-w-7xl mx-auto py-20 px-5">
            ...
            <div className="p-5" data-aos="fade-right" data-aos-duration="2000">
                <h3 className="text-2xl font-bold uppercase text-center">Home is not a place<br /> it's a feeling.</h3>
            ...
            <div className="grid grid-cols-2 gap-4">
                <img src={img1} className="h-52 rounded-xl"  data-aos="zoom-in" data-aos-duration="3000"  data-aos-delay="500"/>
                <img src={img2} className="h-52 rounded-xl"  data-aos="zoom-in" data-aos-duration="3000"  data-aos-delay="1200"/>
                <img src={img3} className="h-52 rounded-xl"  data-aos="zoom-in" data-aos-duration="3000"  data-aos-delay="1900"/>
                <img src={img4} className="h-52 rounded-xl"  data-aos="zoom-in" data-aos-duration="3000"  data-aos-delay="2600"/>
            </div>


            <div className="space-y-3 flex flex-col justify-center" data-aos="fade-left" data-aos-duration="4000">
                <h1 className="text-3xl font-bold text-black uppercase text-balance">Find us on <br /> <span className="text-[#7EA1FF]">the map</span></h1>
                ...
                <a href="https://www.google.com/maps/place/Sylhet/@24.8999805,91.8198358,13z/data=!3m1!4b1!4m6!3m5!1s0x375054d3d270329f:0xf58ef93431f67382!8m2!3d24.9047808!4d91.8600079!16zL20vMDJ0ZDJ4?entry=ttu" 
                 target="_blank"
                className="btn font-bold bg-[#7EA1FF] text-white w-32">Find us <GoLocation className="text-2xl text-[#AF47D2]"/></a>
            </div>
