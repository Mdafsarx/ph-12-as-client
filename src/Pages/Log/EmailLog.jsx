...
const EmailLog = () => {
    ...
    return (
        <div className="flex justify-center min-h-screen items-center" data-aos="zoom-in" data-aos-duration="2000"  data-aos-delay="500">
            <div className="mx-5 md:w-[60%] md:min-h-[75vh] flex flex-col items-center justify-center text-center p-5 md:p-12 shadow-2xl border rounded-md ">
                <h1 className="text-2xl md:text-4xl font-serif ">Welcome back</h1>
                <p className="text-sm md:text-base">Login and enjoy the best  features <br /> of our website</p>

                <div className="mt-3 space-y- flex flex-col items-center">
                    ...
                    <div>
                        <form className="space-y-2 text-black" onSubmit={handleSubmit}>
                            ...
                            <button className="btn bg-[#7EA1FF] text-white btn-block font-bold border-0 hover:bg-[#E49BFF] hover:text-black">{loading ? <TbFidgetSpinner className="animate-spin"/>:'Login Account'}</button>
                        </form>
                    </div>


                    <p className="flex items-center gap-2 mt-3">No account ?
