...
const Register = () => {
    ...
    return (
        <div className="flex justify-center min-h-screen items-center " data-aos="zoom-in" data-aos-duration="2000"      data-aos-delay="500">
            <div className="px-8 md:px-0 md:w-[60%] min-h-[75vh] flex flex-col items-center text-center p-12 shadow-2xl border rounded-md">
                <h1 className="text-4xl font-serif pb-">Welcome back</h1>
                ...
                <div className="mt-2 flex flex-col items-center">
                    ...
                    <div>
                        <form className="space-y-2" onSubmit={handleRegister}>
                            ...
                            <button className="btn bg-[#7EA1FF] text-white btn-block font-bold border-0">{loading ? <TbFidgetSpinner className="animate-spin"/>:'Create Account'}</button>
                        </form>
                    </div>
