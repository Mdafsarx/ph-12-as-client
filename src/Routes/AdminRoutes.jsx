...
const AdminRoutes = () => {
    return (
        <>
            ...
            <NavLink data-aos="fade-right" data-aos-duration="2000" data-aos-delay="1100"
            className={({isActive})=>isActive?
            ...
            <NavLink data-aos="fade-right" data-aos-duration="2000" data-aos-delay="1600"
            className={({isActive})=>isActive?
            ...
            <NavLink data-aos="fade-right" data-aos-duration="2000" data-aos-delay="2100"
            className={({isActive})=>isActive?
            ...
            <NavLink data-aos="fade-right" data-aos-duration="2000" data-aos-delay="2600"
            className={({isActive})=>isActive?
